...
export interface EnergyDialerProps {
  ...
  /** When true, the dialer ignores pointer/keyboard input and reads 0%. */
  disabled?: boolean;
}
 ...
 */
export function EnergyDialer({
  label,
  value,
  onChange,
  disabled = false,
}: EnergyDialerProps): JSX.Element {
  ...
  return (
    <div className="energy-dialer">
      ...
      <div className="energy-dialer__scale">
        ...
        >
          <div className="energy-dialer__fill" style={{ height: `${displayValue}%` }} />
        </div>
      ...
      <div className="energy-dialer__readout">
        ...
        <div className="energy-dialer__readout-value">{displayValue}%</div>
      </div>
    </div>
  );
}
